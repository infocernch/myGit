...
public class MapList {
	...
	public static void main(String[] args) {
		...
		list.add(new Student("202301", "kim", "전산", 1, "pakr"));
		list.add(new Student("20221", "choi", "영문", 2, "kim"));
		list.add(new Student("202001", "lee", "경제", 3, "hong"));
		
		map.put("list", list);//맵에 리스트  추가
		print(map);//압축파일처럼 list안의 3개의 객체가 map에 담겨져 print쪽 매개변수화되어 값을넘김
