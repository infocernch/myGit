...
public class StrMethod {
	public static void main(String[] args) {
		String str1 = "java";
		str1 += " programming"; 
//	 str1 = str1+ programming,문자열 연결이지만 실제로 새로운 문자열을 만들고
//	  str1은 새로운 문자열의 주소값을 가리키게됨.
		System.out.println(str1.length());//문자열의 길이
		String str2 = str1.concat(" programmer");//concat() = 문자열연결
		System.out.println(str2);
		System.out.println(str1);
		System.out.println(str1.charAt(2));//n번쩨 문자
		System.out.println(str2.indexOf("program"));//"program"시작문자열인
//		p 문자의 위치
